...
SPP_NAMED_RECORD(Thread::Atomic, "Atomic", SPP_FIELD(value_));

SPP_NAMED_ENUM(Thread::Priority, "Priority", normal, SPP_CASE(low), SPP_CASE(normal),
               SPP_CASE(high), SPP_CASE(critical));
