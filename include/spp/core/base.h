...
#define SPP_COMPILER_MSVC
#define SPP_FORCE_INLINE __forceinline
#define SPP_MSVC_INTRINSIC [[msvc::intrinsic]]
...
#define SPP_COMPILER_CLANG
#define SPP_FORCE_INLINE __attribute__((always_inline)) inline
#define SPP_MSVC_INTRINSIC
#include <new>
...
#define SPP_ARCH_ARM64
#else
#define SPP_ARCH_OTHER
#endif
